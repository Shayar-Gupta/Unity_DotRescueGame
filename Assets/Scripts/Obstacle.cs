...
{
    [SerializeField] private float _minRotateSpeed, _maxRotateSpeed, _minRotateTime, _maxRotateTime;
    private float currentRotateSpeed, rotateTime, currentRotateTime;
    ...
    private void FixedUpdate(){ transform.Rotate(0, 0, currentRotateSpeed * Time.fixedDeltaTime); }
}
